...
public class VannerController : Controller
{
    ...
    public async Task<IActionResult> taBortVan(string id)
    {
        ...
        // Hitta notisen som skapades vid vänskapens början
        var notis = await _context.Notiser.FirstOrDefaultAsync
            (n => n.AnvandarId == id && 
            n.AvsandareId == userId &&
            n.Meddelande.Contains("har blivit din vän"));
